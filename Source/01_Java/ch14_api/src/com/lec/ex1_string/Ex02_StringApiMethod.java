...
public class Ex02_StringApiMethod {
	public static void main(String[] args) {
		...
		String str3 = "  ja  va2  ";
		System.out.println("1." + str1.concat(str2)); // 둘을 연결 : 1.abcXabcabcXabc
		System.out.println("2." + str1.substring(3)); // 3번째 index부터 끝까지 : 2.Xabc
		System.out.println("3." + str1.substring(3, 5)); // 3번째 index부터 5번째 앞(전)까지 : 3.Xa
		...
		System.out.println("8." + str1.indexOf('b')); // b가 처음 나타나는 index : 8.1
