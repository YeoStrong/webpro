...
-- 218번(원글)
INSERT INTO BOARD (NUM, WRITER, SUBJECT, CONTENT, EMAIL, PW, REF, RE_STEP, RE_INDENT, IP) 
    VALUES (218, '홍준표', '나 대선출마한다', '진짜 할건데\n뽑아주냐?\n뽑아주라', NULL, '111', 218, 0, 0, '222.222.222.222');
-- 218번의 1번째 답글 달기
...
INSERT INTO BOARD (NUM, WRITER, SUBJECT, CONTENT, EMAIL, PW, REF, RE_STEP, RE_INDENT, IP)
    VALUES (219, '홍빠', '무조건 찍는다', '나오기만해\n대통령 가즈아~', 'hongbba@strength.com', '111', 218, 1, 1, '242.242.242.242');
-- 218번의 2번째 답글 달기
    SELECT MAX(NUM) FROM BOARD;
    UPDATE BOARD SET RE_STEP = RE_STEP+1
        WHERE REF=218 AND RE_STEP > 0;
INSERT INTO BOARD (NUM, WRITER, SUBJECT, CONTENT, EMAIL, PW, REF, RE_STEP, RE_INDENT, IP)
    VALUES (220, '홍빠2', '나도 무조건 찍는다', '나오기만해\n대통령 가쥬아~', 'hongbba2@strength.com', '111', 218, 1, 1, '242.242.242.222'); -- 9. 답글 달기
...
INSERT INTO BOARD (NUM, WRITER, SUBJECT, CONTENT, EMAIL, PW, REF, RE_STEP, RE_INDENT, IP)
    VALUES ((SELECT NVL(MAX(NUM),0)+1 FROM BOARD), '홍안티', '응 안찍어', '나오기만해\n바로 광탈~', 'hongAnti@nohong.com', '111', 218, 1, 2, '131.131.131.131');
