...
<body>
	<%
		...
		if("y".equals(agree)){
			// 약관에 동의한 경우 : 세션속성값(id, pw, name) 받아 파일에 저장, 세션 삭제(pw, name) -> 다음 페이지로
			String id = (String)session.getAttribute("id");
			String pw = (String)session.getAttribute("pw");
			String name = (String)session.getAttribute("name");
			// 파일 저장(소스폴더의 webContent/WEB-INF/id.txt)
			String filePath = "C:/Users/EZEN 203/Desktop/YeosongYoon/WebProgramming/Source/06_jsp/ch08_session/WebContent/WEB-INF/"+id+".txt";
