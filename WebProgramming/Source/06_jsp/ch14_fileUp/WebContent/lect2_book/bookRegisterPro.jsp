...
<body>
		...
		for(String imgfile : images){
			...
			if(serverfile.exists()){
				try{
					...
					os = new FileOutputStream("D:\\YeosongYoon\\WebProgramming\\Source\\06_jsp\\ch14_fileUp\\WebContent\\bookImg\\"+imgfile);
	...
	<a href="ex4_list.jsp">1page 리스트(product list 스타일)</a><br>
</body>
</html>
