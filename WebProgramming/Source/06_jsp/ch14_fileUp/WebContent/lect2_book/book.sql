...
CREATE TABLE BOOK(
    ...
    CATEGORY_CODE NUMBER(3) REFERENCES BOOKCATEGORY(CATEGORY_CODE), -- NOT NULL을 추가 안하면 참조테이블의 PRIMARY KEY임에도 NULL값이 들어갈수도 있음.
...
CREATE TABLE BOOK(
    ...
    bCONTENT VARCHAR2(4000),        -- 책 설명(VARCHAR2는 4000이 최대값)
    bDISCOUNT NUMBER(3) NOT NULL,   -- 할인율
    bRDATE    DATE DEFAULT SYSDATE NOT NULL
);
CREATE SEQUENCE BOOK_SEQ MAXVALUE 9999999 NOCACHE NOCYCLE;-- NOCACHE를 하지 않으면 미리 만들어 놓음
SELECT * FROM BOOK;
-- 책 등록
INSERT INTO BOOK (bID, bTITLE, bPRICE, bIMAGE1, bIMAGE2, bCONTENT, bDISCOUNT) 
    VALUES (BOOK_SEQ.NEXTVAL, '이것이 자바다', 20000, 'noImg.png', 'NOTHING.JPG', '두꺼워', 10);
INSERT INTO BOOK (bID, bTITLE, bPRICE, bIMAGE1, bIMAGE2, bCONTENT, bDISCOUNT) 
    VALUES (BOOK_SEQ.NEXTVAL, 'PYTHON IS GOD', 30000, 'NOTHING.JPG', 'noImg.png', '딱좋아', 15);
INSERT INTO BOOK (bID, bTITLE, bPRICE, bIMAGE1, bIMAGE2, bCONTENT, bDISCOUNT) 
    VALUES (BOOK_SEQ.NEXTVAL, '불쏘시개', 50000, 'NOTHING.JPG', 'noImg.png', '쓰레기야', 90);
-- 책 리스트 (PAGING 없이)
