...
<body>
	<form action="${conPath }/empSch">
		<p class="paging">
			이름 <input type="text" name="schName" value="${param.schName.toUpperCase().trim() }" style="width:30%;">
			직책 <input type="text" name="schJob" value="${fn:toUpperCase(fn:trim(param.schJob)) }" style="width:30%;">
			<input type="submit" value="검색" style="width:15%;">
		</p>
	</form>
	<table>
		<tr>
