...
<body>
	...
	<p>세자리마다 , : <fmt:formatNumber value="${num }" pattern="#,###.#"/>(소수점 1자리까지 나오도록 반올림)</p>
	<p>세자리마다 , : <fmt:formatNumber value="${num }" pattern="#,###.###"/></p>
	<c:set var="pi" value="3.14159"/>
	<p> pi : <fmt:formatNumber value="${pi }" pattern="#,###.###"/>
	<p> pi : <fmt:formatNumber value="${pi }" pattern="000.000000"/>
</body>
</html>