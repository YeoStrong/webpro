...
public class FrontController extends HttpServlet {
	...
	private void actionDo(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// 무슨 요청이 들어왔는지 판별(select.do? delete.do? update.do? delete.do?)하고 해당 요청을 수행하고 view로 forward한다
		...
		Service service = null; // InsertService나 SelectService나 DeleteService나 UpdateService 객체
