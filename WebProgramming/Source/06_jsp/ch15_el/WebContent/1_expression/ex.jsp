...
<body>
	<h1>표현식 태그 이용</h1>
	<p>산술연산자 : 10+1 = <%=10+1 %></p>
	<p>산술연산자 : 10/0.0 = <%=10/0.0 %></p> <!-- 0으로 나누면 에러, 0.0으로 나누면 가능(infinity) -->
	<p>관계연산자 : 1 > 2 = <%=1 > 2 %></p>
	<p>관계연산자 : 1==2 = <%=1 == 2 %></p>
	<p>관계연산자 : 1!=2 = <%=1 != 2 %></p>
	...
	<h1>EL 표기법(표현식 안에 쓸 수 있는 연산자는 다 사용가능)</h1>
	<p>산술연산자 : 10+1 = ${10+1 } </p>
	<p>산술연산자 : 10/0 = ${10/0 } </p>
	<p>관계연산자 : 1 > 2 = ${1 > 2 }</p>
	...
	<p>pageNum 파라미터 여부 : ${empty param.pageNum ? "pageNum 안 옴":"pageNum 옴" }
