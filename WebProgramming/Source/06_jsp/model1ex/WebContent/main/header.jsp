...
<body>
	<header>
		<div class="gnb">
			...
			<%}else{ // 로그인 후 메뉴(고객센터, 로그아웃, 정보수정, 이름 님)%>
				<ul>
					<li><a href="<%=conPath%>/fileboard/fboardList.jsp">고객센터</a></li>
		...
		<div class="logo" onclick="location.lref='<%=conPath%>/'">
			<img src="https://www.moel.go.kr/images/layout/logo.png">
		</div>
		<div class="lnb">
			<ul>
				<li><a href="<%=conPath%>/book/bookList.jsp">도서 목록</a></li>
				<%if(customer!=null){ %>
					<li><a href="<%=conPath%>/book/bookRegister.jsp">도서 등록</a></li>
				<%} %>
			</ul>
		</div>
	</header>
