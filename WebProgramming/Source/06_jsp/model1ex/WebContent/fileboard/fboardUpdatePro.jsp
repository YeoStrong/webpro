	...
	<%
		...
		if(ffilename!=null){
			...
			try{
				...
				os = new FileOutputStream("C:/Users/EZEN 203/Desktop/YeosongYoon/WebProgramming/Source/06_jsp/model1ex/WebContent/fileboardUpload/"+ffilename);
		...
		// ffilename이 null이면 ffilename대신 dbfilename으로 dto의 ffilename을 셋팅
