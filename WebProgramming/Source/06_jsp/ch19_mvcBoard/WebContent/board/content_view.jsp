...
<body>
	<table>
		...
		<tr>
			<th>작성일</th>
			<td><fmt:formatDate value="${contentBoard.bdate }" pattern="yy/MM/dd(E) HH:mm:ss:SSS"/></td>
		</tr>
		<tr><th>조회수</th><td>${contentBoard.bhit }</td></tr>
		<tr><th>IP</th><td>${contentBoard.bip }</td></tr>
		<tr>
			<td colspan="2">
				<button onclick="location.href='${conPath}/modifyView.do?bid=${param.pageNum }&pageNum=${param.pageNum}'">수정</button>
