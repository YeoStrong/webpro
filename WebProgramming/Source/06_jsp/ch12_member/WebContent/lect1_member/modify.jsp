			...
			<tr>
				...
				<td>
					<select name="phone1">
						...
						<option<%if("02".equals(phone2)){out.print("selected='selected'");} %>>02</option>
						<option<%if("031".equals(phone2)){out.print("selected='selected'");} %>>031</option>
						<option<%if("032".equals(phone2)){out.print("selected='selected'");} %>>032</option>
					</select> - 
